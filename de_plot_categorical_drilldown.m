...
if ~isempty(wide_yr_idxs) && isempty(time_idx)
    ...
    de_geobins(T_long, 'GeoCol', catname, 'Grid', grid_name, 'ColorVariable', 'Value', ...
    ...
    for sci = 1:numel(sub_cats)
        ...
        de_geobins(T_long, 'GeoCol', catname, 'Grid', grid_name, ...
            ...
            'GroupVariable',  sc,      'ColorVariable', 'Value', ...
...
for j = 1:numel(num_idxs)
    ...
    if isempty(tcn)
        de_geobins(T, 'GeoCol', catname, 'Grid', grid_name, 'ColorVariable', ncn, ...
            'Title', fig_title_str);
    else
        de_geobins(T, 'GeoCol', catname, 'Grid', grid_name, 'ColorVariable', ncn, ...
